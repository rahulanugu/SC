...
async function createTable() {
    ...
    const schema = 'id:string, firstName:string, lastName:string, companyName:string,\
    roleInCompany:string,email:string,password:string,phone:string,version:integer';

...
export class AllscriptsLoginComponent implements OnInit {
  ...
  onSubmit() {
    ...
    const headers = {
      ...
      'Host': 'applescm184region.open.allscripts.com',
    ...
    this.http.post("https://applescm184region.open.allscripts.com/authorization/connect/token", body, {
      headers
...
/* var myHeaders = new Headers();
        ...
        fetch("https://api.Allscriptshealth.com/oauthpreview/token",requestOptions)
